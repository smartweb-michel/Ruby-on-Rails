...
1. Get the code. Clone this git repository and check out the latest release:
  ...
  ```bash
  git clone git://github.com/smartweb-michel/Ruby-on-Rails.git
  cd Ruby-on-Rails
  git checkout latest
  ```
...
Browse open issues and submit new ones at http://github.com/smartweb-michel/Ruby-on-Rails/issues.
